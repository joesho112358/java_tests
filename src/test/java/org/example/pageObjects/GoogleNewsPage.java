...
public class GoogleNewsPage {
    ...
    /**
     * Navigates to Google News and returns the initial results container for later validation.
     * @return The initial visible article element.
     */
    public WebElement loadPage() {
        driver.get("https://news.google.com/");
        return wait.until(ExpectedConditions.visibilityOfElementLocated(initialResultsContainer));
    }

    /**
     * Performs a search for the given query.
     * @param query The search term (e.g., "Technology").
     */
